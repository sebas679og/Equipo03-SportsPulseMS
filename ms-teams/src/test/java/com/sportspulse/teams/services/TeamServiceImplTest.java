...
class TeamServiceImplTest {
  ...
  @Test
  @DisplayName(
      "getTeamById() throws CustomTooManyRequestsException when errors contain 'requests' key")
  void getTeamById_whenErrorsContainRequestsKey_throwsCustomTooManyRequestsException() {
    ApiFootballTeamResponse apiResponse =
        buildApiResponseWithErrors(Map.of("requests", "Rate limit exceeded"));
    given(footballClient.getApiFootballTeamById(TEAM_ID)).willReturn(apiResponse);
  ...
  void getTeamById_whenErrorsContainPlanKey_throwsCustomTooManyRequestsException() {
    ApiFootballTeamResponse apiResponse =
        buildApiResponseWithErrors(Map.of("plan", "Season limit exceeded"));
    given(footballClient.getApiFootballTeamById(TEAM_ID)).willReturn(apiResponse);
  ...
  @Test
  @DisplayName(
      "getTeamById() uses plan message as exception message when errors contain 'plan' key")
  void getTeamById_whenErrorsContainPlanKey_usesPlanMessageAsExceptionMessage() {
    ...
    ApiFootballTeamResponse apiResponse = buildApiResponseWithErrors(Map.of("plan", planMessage));
    given(footballClient.getApiFootballTeamById(TEAM_ID)).willReturn(apiResponse);
  ...
  void getTeamById_whenErrorsContainUnknownKey_throwsCustomBadGatewayException() {
    ApiFootballTeamResponse apiResponse =
        buildApiResponseWithErrors(Map.of("token", "Invalid API token"));
    given(footballClient.getApiFootballTeamById(TEAM_ID)).willReturn(apiResponse);
  ...
  void getTeamLeagueSeasonByTeamId_whenApiReturnsItems_returnsMappedResponse() {
    ...
    given(footballClient.getApiFootballTeamByLeagueAndSeason(LEAGUE_ID, SEASON))
        .willReturn(apiResponse);
    given(teamMapper.toTeamLeagueSeasonResponse(item))
        .willReturn(mock(TeamLeagueSeasonResponse.class));
  ...
  void getTeamLeagueSeasonByTeamId_mapsAllItemsFromApiResponse() {
    ...
    given(footballClient.getApiFootballTeamByLeagueAndSeason(LEAGUE_ID, SEASON))
        .willReturn(apiResponse);
    given(teamMapper.toTeamLeagueSeasonResponse(any()))
        .willReturn(mock(TeamLeagueSeasonResponse.class));
  ...
  @Test
  @DisplayName(
      "getTeamLeagueSeasonByTeamId() parses season string to int before calling FootballClient")
  ...
  @Test
  @DisplayName(
      "getTeamLeagueSeasonByTeamId() throws CustomNotFoundException when response list is empty")
  ...
  @Test
  @DisplayName(
      "getTeamLeagueSeasonByTeamId() throws CustomNotFoundException when response list is null")
  ...
  void whenErrorsContainRequestsKey_throwsCustomTooManyRequestsException() {
    ApiFootballTeamResponse apiResponse =
        buildApiResponseWithErrors(Map.of("requests", "Rate limit exceeded"));
    LeagueAndSeasonRequest request = buildRequest(LEAGUE_ID, SEASON);
    given(footballClient.getApiFootballTeamByLeagueAndSeason(LEAGUE_ID, SEASON))
  ...
  @Test
  @DisplayName("throws CustomBadGatewayException when errors contain unknown key")
  void getTeamLeagueSeasonByTeamId_whenErrorsContainUnknownKey_throwsCustomBadGatewayException() {
    ApiFootballTeamResponse apiResponse =
        buildApiResponseWithErrors(Map.of("token", "Invalid token"));
    LeagueAndSeasonRequest request = buildRequest(LEAGUE_ID, SEASON);
    given(footballClient.getApiFootballTeamByLeagueAndSeason(LEAGUE_ID, SEASON))
        .willReturn(apiResponse);
  ...
  @Test
  @DisplayName(
      "getTeamLeagueSeasonByTeamId() throws NumberFormatException when season is not numeric")
