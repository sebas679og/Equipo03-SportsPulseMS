...
class FootballClientImplTest {
    ...
    private void givenWebClientStatusTriggers(int statusCode) {
        ...
        given(responseSpec.onStatus(any(), any())).willAnswer(invocation -> {
    ...
    @Test
    @DisplayName("getApiFootballTeamById() throws CustomServiceUnavailableException when body is empty")
    ...
    @Test
    @DisplayName("getApiFootballTeamByLeagueAndSeason() returns the team response when API call succeeds")
    void getApiFootballTeamByLeagueAndSeason_whenApiReturnsBody_returnsTeamResponse() {
        ApiFootballTeamResponse expected = mock(ApiFootballTeamResponse.class);
        givenWebClientReturns(expected);

        ApiFootballTeamResponse result = footballClient.getApiFootballTeamByLeagueAndSeason(LEAGUE_ID, SEASON);
    ...
    @Test
    @DisplayName("getApiFootballTeamByLeagueAndSeason() throws CustomServiceUnavailableException on 204 response")
    ...
    @Test
    @DisplayName("getApiFootballTeamByLeagueAndSeason() throws CustomServiceUnavailableException on 499 response")
    ...
    @Test
    @DisplayName("getApiFootballTeamByLeagueAndSeason() throws CustomServiceUnavailableException on 500 response")
    ...
    @Test
    @DisplayName("getApiFootballTeamByLeagueAndSeason() throws CustomServiceUnavailableException when body is empty")
    void getApiFootballTeamByLeagueAndSeason_whenBodyIsEmpty_throwsCustomServiceUnavailableException() {
        givenWebClientReturns(null);
