 ...
 *
 * <p>Fetches raw team and venue data, transforms it into the internal
 * {@link TeamResponse} format and returns it to the controller layer.
 */
@Service
...
public class TeamService {
    ...
    public List<TeamResponse> getTeams(Integer league, Integer season) {
        ApiFootballResponse response = footballWebClient.get()
