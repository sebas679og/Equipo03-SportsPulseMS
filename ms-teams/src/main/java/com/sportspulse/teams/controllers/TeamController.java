 ...
 *
 * <p>Exposes endpoints to retrieve team information by league and season, sourced from the
...
public class TeamController {
  ...
  @Operation(
      ...
      description =
          "Returns all teams participating in a given league and season. "
  ...
  public ResponseEntity<List<TeamResponse>> getTeams(
      @Parameter(description = "League identifier (e.g. 39 for Premier League).", required = true)
          @RequestParam
          Integer league,
      @Parameter(description = "Season year (e.g. 2023).", required = true) @RequestParam
          Integer season) {
