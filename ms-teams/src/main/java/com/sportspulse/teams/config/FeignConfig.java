 ...
 *
 * <p>Registers a {@link RequestInterceptor} that automatically injects the internal API key header
 * into every outgoing Feign request.
 */
public class FeignConfig {
   ...
   *
   * @return a RequestInterceptor that injects {@value HttpHeaders#X_INTERNAL_API_KEY} into every
   *     Feign request.
   */
  @Bean
