 ...
 *
 * <p>Defines the HTTP security filter chain, disables CSRF for stateless REST APIs,
 * enforces JWT authentication on protected endpoints and registers the
 * {@link JwtAuthenticationFilter} before Spring's default authentication filter.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(ApiPaths.Docs.SWAGGER_UI, ApiPaths.Docs.API_DOCS, ApiPaths.Docs.SWAGGER_UI_HTML)
                        .permitAll()
