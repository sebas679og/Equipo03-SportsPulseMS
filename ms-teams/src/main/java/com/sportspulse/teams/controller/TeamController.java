...
@Tag(
        ...
        description = "Endpoints related to teams, allowing clients to retrieve information about teams from API-Football."
)
public class TeamController {
  ...
  @ApiResponses({
          @ApiResponse(
                  responseCode = "200",
                  description =
                          "Successful response - team information retrieved successfully",
                  content =
                  @Content(
