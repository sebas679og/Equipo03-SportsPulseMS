...
public class CacheConfig {
  ...
  private final StandingsCacheProperties properties;

  /**
   * Creates and configures the {@link CacheManager} for the application. If caching is disabled in
   * {@link StandingsCacheProperties}, a {@link NoOpCacheManager} is returned. Otherwise, a {@link
